...
def create_bot_corpus(words, classes, pattern_word_tags_list, ignore_words):
    ...
    for intent in data['intents']:
        ...
        for pattern in intent['patterns']:  
            ...
            pattern_word_tags_list.append(words,intent['tag'])
...
def created_bot_corpus(stem_words,classes):
     stem_words = sorted(list(set(stem_words)))
     classes = sorted(list(set(classes)))

     return stem_words,classes

stem_words,classes = created_bot_corpus(stem_words,classes)
